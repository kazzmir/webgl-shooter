...
const (
	ElementPhysical  ElementType = "Physical"
	ElementPlasma    ElementType = "Plasma"
	ElementLightning ElementType = "Lightning"
)

func elementTypeOrDefault(current ElementType, fallback ElementType) ElementType {
	if current != "" {
		return current
	}
...
func (basic *BasicGun) ElementType() ElementType {
	return elementTypeOrDefault(basic.elementType, ElementPhysical)
}
...
func (dual *DualBasicGun) ElementType() ElementType {
	return elementTypeOrDefault(dual.elementType, ElementPhysical)
}
...
func (beam *BeamGun) ElementType() ElementType {
	return elementTypeOrDefault(beam.elementType, ElementPlasma)
}
...
func (missle *MissleGun) ElementType() ElementType {
	return elementTypeOrDefault(missle.elementType, ElementPhysical)
}
...
func (lightning *LightningGun) ElementType() ElementType {
	return elementTypeOrDefault(lightning.elementType, ElementLightning)
}
